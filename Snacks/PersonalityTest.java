...
public class PersonalityTest {
    ...
    private static void displayChoiceCounts(List<String> answers) {
        ...
        System.out.println(String.format("Number of A selected: %d", countA));
        System.out.println(String.format("Number of B selected: %d", countB));
    }
}
